#Pg.123 >>>  5.1 – Testes condicionais: Escreva uma série de testes condicionais. 
#Exiba uma frase que descreva o teste e o resultado previsto para cada um. 
#Seu código deverá ser semelhante a: car = 'subaru' print("Is car =='subaru'? I predict True.") print(car == 'subaru')
